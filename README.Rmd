...
You can install the development version of aurora from [GitHub](https://github.com/DalimilBujdos/aurora/) with:

``` r
# install.packages("devtools")
devtools::install_github("DalimilBujdos/aurora")
```
For instructions on how to use the package, please refer to [vignettes](https://dalimilbujdos.github.io/aurora/articles/panGWAS.html)
